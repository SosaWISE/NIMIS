		...
		*/
		...
		public static MsAccountSetupCheckList CastFnsToMsAccountSetupCheckList(IFnsMsAccountSetupCheckList keyValue)
		{
			return new MsAccountSetupCheckList
			{
				...
				Qualify = (keyValue.Qualify != null),
				QualifyDate = keyValue.Qualify,
				SalesInfo = (keyValue.SalesInfo != null),
				SalesInfoDate = keyValue.SalesInfo,
				PreSurvey = (keyValue.PreSurvey != null),
				PreSurveyDate = keyValue.PreSurvey,
				IndustryNumbers = (keyValue.IndustryNumbers != null),
				IndustryNumbersDate = keyValue.IndustryNumbers,
				EmergencyContacts = (keyValue.EmergencyContacts != null),
				EmergencyContactsDate = keyValue.EmergencyContacts,
				SystemDetails = (keyValue.SystemDetails != null),
				SystemDetailsDate = keyValue.SystemDetails,
				RegisterCell = (keyValue.RegisterCell != null),
				RegisterCellDate = keyValue.RegisterCell,
				SystemTest = (keyValue.SystemTest != null),
				SystemTestDate = keyValue.SystemTest,
				TechInspection = (keyValue.TechInspection != null),
				TechInspectionDate = keyValue.TechInspection,
				PostSurvey = (keyValue.PostSurvey != null),
				PostSurveyDate = keyValue.PostSurvey,
				InitialPayment = (keyValue.InitialPayment != null),
				InitialPaymentDate = keyValue.InitialPayment,
				SubmitAccountOnline = (keyValue.SubmitAccountOnline != null),
				SubmitAccountOnlineDate = keyValue.SubmitAccountOnline,
			};
		}
	}
}