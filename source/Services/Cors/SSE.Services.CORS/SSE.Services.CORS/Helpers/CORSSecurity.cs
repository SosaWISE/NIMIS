...
namespace SSE.Services.CORS.Helpers
{
	public static class CORSSecurity
	{
		...
		public static SosCORSResult<T> AuthenticationWrapper<T>(string functionName, Func<SosCustomer, SosCORSResult<T>> action)
		{
			#region Authentication
			/** Authenticate. */
			SosCustomer oUser;
			var oResult = new SosCORSResult<T>((int)SosResultCodes.CookieInvalid
