...
using SOS.Data;
using SOS.Lib.Util;
using AR = NXS.Data.Accounting.Models.TaxCode;
				...
				if (_taxCodes == null)
				{
					lock (_syncRootTaxCodes)
					{
						if (_taxCodes == null)
						{
							...
							foreach (TaxCode curr in controller.LoadCollectionByProcedure(AccountingDataStoredProcedureManager.CustGetTaxCodes()))
							{
