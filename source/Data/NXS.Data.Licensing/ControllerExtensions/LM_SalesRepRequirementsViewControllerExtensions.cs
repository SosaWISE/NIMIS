...
// ReSharper disable once InconsistentNaming
	...
	{
		public static ARCollection GetSalesRepCompliance(this ARController cntlr, string countryName, string stateName, string countyName, string cityName, string townshipName, string salesRepId, int seasonId)
		{
			return
				cntlr.LoadCollection(LicensingDataStoredProcedureManager.LM_RequirementsGetRepLicenseByLocation(countryName,
					stateName, countyName, cityName, townshipName, salesRepId, seasonId));
		}
	}
}
