...
{
	using AR = SL_ContactAddress;
	using ARCollection = IEnumerable<SL_ContactAddress>;
	using ARTable = DBase.SL_ContactAddressTable;
	public static class SL_ContactAddressTableExtensions
	{
