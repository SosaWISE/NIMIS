...
{
	using AR = SL_ContactFollowup;
	using ARCollection = IEnumerable<SL_ContactFollowup>;
	using ARTable = DBase.SL_ContactFollowupTable;
	public static class SL_ContactFollowupTableExtensions
	{
