...
namespace SSE.FOS.AddressVerificationUT
{
	...
	public class IntelligentSearch
	{
		...
		[TestMethod]
		public void IntelligentSearch_ArgValidation()
		{
			// ** Initialize. 
			var oService = new AddressVerification.Main(AddressVerification.Main.Vendors.INTELI_SRCH);
		...
		[TestMethod]
		public void IntelligentSearch_ArgValidationPasses()
		{
			// ** Initialize. 
			var oService = new AddressVerification.Main(AddressVerification.Main.Vendors.INTELI_SRCH);
