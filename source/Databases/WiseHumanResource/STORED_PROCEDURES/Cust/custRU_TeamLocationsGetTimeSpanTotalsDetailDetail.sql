...
IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'custRU_TeamLocationsGetTimeSpanTotalsDetailDetail')
	BEGIN
		PRINT 'Dropping Procedure custRU_TeamLocationsGetTimeSpanTotalsDetailDetail'
		DROP  Procedure  dbo.custRU_TeamLocationsGetTimeSpanTotalsDetailDetail
	END
GO

PRINT 'Creating Procedure custRU_TeamLocationsGetTimeSpanTotalsDetailDetail'
GO
/******************************************************************************
**		File: custRU_TeamLocationsGetTimeSpanTotalsDetailDetail.sql
**		Name: custRU_TeamLocationsGetTimeSpanTotalsDetailDetail
**		Desc: 
**
...
*******************************************************************************/
CREATE Procedure dbo.custRU_TeamLocationsGetTimeSpanTotalsDetailDetail
...
GRANT EXEC ON dbo.custRU_TeamLocationsGetTimeSpanTotalsDetailDetail TO PUBLIC
GO