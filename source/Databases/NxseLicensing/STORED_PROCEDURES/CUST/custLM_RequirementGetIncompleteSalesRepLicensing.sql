...
IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'custLM_RequirementGetIncompleteSalesRepLicensing')
	BEGIN
		PRINT 'Dropping Procedure custLM_RequirementGetIncompleteSalesRepLicensing'
		DROP  Procedure  dbo.custLM_RequirementGetIncompleteSalesRepLicensing
	END
GO

PRINT 'Creating Procedure custLM_RequirementGetIncompleteSalesRepLicensing'
GO
/******************************************************************************
**		File: custLM_RequirementGetIncompleteSalesRepLicensing.sql
**		Name: custLM_RequirementGetIncompleteSalesRepLicensing
**		Desc: 
**
...
**	
*******************************************************************************/
CREATE Procedure [dbo].[custLM_RequirementGetIncompleteSalesRepLicensing]
(
	@SeasonID INT = NULL
)
AS
...
GRANT EXEC ON dbo.custLM_RequirementGetIncompleteSalesRepLicensing TO PUBLIC
GO

/** EXEC dbo.custLM_RequirementGetIncompleteSalesRepLicensing */