...
IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'custLM_RequirementsGetCompanyLicenseByLocation')
	BEGIN
		PRINT 'Dropping Procedure custLM_RequirementsGetCompanyLicenseByLocation'
		DROP  Procedure  dbo.custLM_RequirementsGetCompanyLicenseByLocation
	END
GO

PRINT 'Creating Procedure custLM_RequirementsGetCompanyLicenseByLocation'
GO
/******************************************************************************
**		File: custLM_RequirementsGetCompanyLicenseByLocation.sql
**		Name: custLM_RequirementsGetCompanyLicenseByLocation
**		Desc: 
**
...
**	
*******************************************************************************/
CREATE Procedure [dbo].[custLM_RequirementsGetCompanyLicenseByLocation]
(
...
GRANT EXEC ON dbo.custLM_RequirementsGetCompanyLicenseByLocation TO PUBLIC
GO

/** EXEC dbo.custLM_RequirementsGetCompanyLicenseByLocation */