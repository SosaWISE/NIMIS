...
IF EXISTS (SELECT * FROM sysobjects WHERE type = 'V' AND name = 'vwSE_TechnicianScheduleBlocks')
	BEGIN
		PRINT 'Dropping VIEW vwSE_TechnicianScheduleBlocks'
		DROP VIEW dbo.vwSE_TechnicianScheduleBlocks
	END
GO

PRINT 'Creating VIEW vwSE_TechnicianScheduleBlocks'
GO

/****** Object:  View [dbo].[vwSE_TechnicianScheduleBlocks]    Script Date: 01/10/2011 15:18:27 ******/
SET ANSI_NULLS ON
GO
...
/******************************************************************************
**		File: vwSE_TechnicianScheduleBlocks.sql
**		Name: vwSE_TechnicianScheduleBlocks
**		Desc: 
**
...
*******************************************************************************/
CREATE VIEW [dbo].[vwSE_TechnicianScheduleBlocks]
AS
	-- Enter Query here
	SELECT
		SESB.[BlockID]
...
-- select * from [dbo].[vwSE_TechnicianScheduleBlocks]
