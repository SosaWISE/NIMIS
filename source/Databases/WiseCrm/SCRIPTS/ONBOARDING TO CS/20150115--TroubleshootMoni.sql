...
GO
/** Declarations */
DECLARE @AccountID BIGINT = '191099';
...
WHERE (AccountSubmitID IN (SELECT TOP 3 AccountSubmitID FROM dbo.MS_AccountSubmits WHERE AccountId = @AccountID ORDER BY AccountSubmitID DESC))
