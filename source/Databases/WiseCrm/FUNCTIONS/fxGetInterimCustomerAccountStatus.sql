...
IF EXISTS (SELECT * FROM sysobjects WHERE (type = 'TF' OR type = 'IF' OR type = 'FN') AND name = 'fxGetInterimCustomerAccountStatus')
	BEGIN
		PRINT 'Dropping FUNCTION fxGetInterimCustomerAccountStatus'
		DROP FUNCTION  dbo.fxGetInterimCustomerAccountStatus
	END
GO

PRINT 'Creating FUNCTION fxGetInterimCustomerAccountStatus'
GO
/******************************************************************************
...
**	
*******************************************************************************/
CREATE FUNCTION dbo.fxGetInterimCustomerAccountStatus
(
...
/*
	...
	print dbo.fxGetInterimCustomerAccountStatus(100030)
