...
IF EXISTS (SELECT * FROM sysobjects WHERE (type = 'TF' OR type = 'IF') AND name = 'fxSCV3_0GetScriptHeaderInfo')
	BEGIN
		PRINT 'Dropping FUNCTION fxSCV3_0GetScriptHeaderInfo'
		DROP FUNCTION  dbo.fxSCV3_0GetScriptHeaderInfo
	END
GO

PRINT 'Creating FUNCTION fxSCV3_0GetScriptHeaderInfo'
GO
/******************************************************************************
**		File: fxSCV3_0GetScriptHeaderInfo.sql
**		Name: fxSCV3_0GetScriptHeaderInfo
**		Desc: 
**
...
**	
*******************************************************************************/
CREATE FUNCTION dbo.fxSCV3_0GetScriptHeaderInfo
(
)
RETURNS 
@ResultList table
...
END
GO
SELECT * FROM dbo.fxSCV3_0GetScriptHeaderInfo();