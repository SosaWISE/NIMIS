...
namespace NXS.Framework.Wpf.Mvvm
{
	...
	/// </summary>
	/// <example>
	/// <![CDATA[  <Window mvvm:LifetimeEvent.Close="{Binding CloseCommand}" />  ]]>
	/// </example>
	public static class LifetimeEvent
	{
		...
		public static readonly DependencyProperty LoadedProperty =
			DependencyProperty.RegisterAttached("Loaded", typeof(ICommand), typeof(LifetimeEvent), new UIPropertyMetadata(null, OnLoadedEventInfoChanged));
		...
		public static readonly DependencyProperty ActivatedProperty =
			DependencyProperty.RegisterAttached("Activated", typeof(ICommand), typeof(LifetimeEvent), new UIPropertyMetadata(null, OnActivatedEventInfoChanged));
		...
		public static readonly DependencyProperty DeactivatedProperty =
			DependencyProperty.RegisterAttached("Deactivated", typeof(ICommand), typeof(LifetimeEvent), new UIPropertyMetadata(null, OnDeactivatedEventInfoChanged));
		...
		public static readonly DependencyProperty CloseProperty =
			DependencyProperty.RegisterAttached("Close", typeof(ICommand), typeof(LifetimeEvent), new UIPropertyMetadata(null, OnCloseEventInfoChanged));
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private static void CanWindowClose(object sender, CancelEventArgs e)
		{
			if (!e.Cancel) {
				var dpo = (DependencyObject)sender;
				ICommand ic = GetClose(dpo);
				if (ic != null) {
					e.Cancel = !ic.CanExecute(e);
				}
			}
		}
		...
		#region Closing
		/// <summary>
		/// Dependency property which holds the ICommand for the Closing event
		/// </summary>
		public static readonly DependencyProperty ClosingProperty =
			DependencyProperty.RegisterAttached("Closing", typeof(ICommand), typeof(LifetimeEvent), new UIPropertyMetadata(null, OnClosingEventInfoChanged));
		...
		/// <summary>
		/// This is the property changed handler for the Closing property.
		/// </summary>
		/// <param name="sender">Dependency Object</param>
		/// <param name="e">EventArgs</param>
		...
		public static readonly DependencyProperty UnloadedProperty =
			DependencyProperty.RegisterAttached("Unloaded", typeof(ICommand), typeof(LifetimeEvent), new UIPropertyMetadata(null, OnUnloadedEventInfoChanged));
		...
		/// <param name="sender">Dependency Object</param>
		/// <param name="e">EventArgs</param>
		private static void OnUnloadedEventInfoChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
		{
			var win = sender as Window;
		...
		public static readonly DependencyProperty CommandParameterProperty =
			DependencyProperty.RegisterAttached("CommandParameter", typeof(object), typeof(LifetimeEvent), new UIPropertyMetadata(null));
