...
namespace NXS.Framework.Wpf.Mvvm
{
	...
	public static class UserControlLifetimeEvent
	{
		...
		public static readonly DependencyProperty LoadedProperty =
			DependencyProperty.RegisterAttached("Loaded", typeof(ICommand), typeof(UserControlLifetimeEvent), new UIPropertyMetadata(null, OnLoadedEventInfoChanged));
		...
		public static readonly DependencyProperty UnloadedProperty =
			DependencyProperty.RegisterAttached("Unloaded", typeof(ICommand), typeof(UserControlLifetimeEvent), new UIPropertyMetadata(null, OnUnloadedEventInfoChanged));
		...
		public static readonly DependencyProperty CommandParameterProperty =
			DependencyProperty.RegisterAttached("CommandParameter", typeof(object), typeof(UserControlLifetimeEvent), new UIPropertyMetadata(null));
