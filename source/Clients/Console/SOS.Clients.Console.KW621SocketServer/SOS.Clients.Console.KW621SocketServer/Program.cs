...
using SOS.Clients.Console.KW621SocketServer.Servers;
using SOS.Data;
...
namespace SOS.Clients.Console.KW621SocketServer
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			DBErrorManager.Instance.AddSuccessMessage("START KW621 CSS Configuration"
				, "Server starting up.");
			...
			DBErrorManager.Instance.AddSuccessMessage("  END KW621 CSS Configuration"
				, "Server initialized.");
		}
		...
		private static KW621PushServer _pushServer;
		...
		private static void InitSocketServer()
		{
			try
			{
				...
				{
					var sKW621GpsTrackerClient = new KW621GpsTracker(_serverListener, threadNumberID);
					_clientsList.Add(threadNumberID, sKW621GpsTrackerClient);
					var t = new Thread(sKW621GpsTrackerClient.ServiceEntryPoint);
					t.Start();
				...
				_pushServer = new KW621PushServer(_clientsList);
