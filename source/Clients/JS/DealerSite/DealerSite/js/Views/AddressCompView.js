...
Ext.define("SOS.Views.AddressCompView",
	{
		extend: 'Ext.window.Window',
		alias: 'widget.AddressCompView',
		statics:
		{
			Instance: function ()
			{
				/** Initialize. */
				return new SOS.Views.AddressCompView();
			}
		},
		...
		constructor: function(options)
		{
			...
			var config = {
				...
				tpl: SOS.UI.Services.GetTemplate('AddressCompView.html'),
				data: options.data
			};
