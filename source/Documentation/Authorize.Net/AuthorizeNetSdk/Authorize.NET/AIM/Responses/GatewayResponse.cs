...
namespace AuthorizeNet
{
	public class GatewayResponse : ResponseBase, IGatewayResponse
	{
		...
		{
			Dictionary<int, string> result = APIResponseKeys;
