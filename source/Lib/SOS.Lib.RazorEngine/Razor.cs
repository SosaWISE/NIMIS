namespace SOS.Lib.RazorEngine
{
	...
	public static class Razor
	{
		...
		public static void AddResolver(TemplateResolverDelegate resolverDelegate)
		{
		...
		public static void Compile(string template, string name, string location = null)
		{
			DefaultTemplateService.CompileWithAnonymous(template, name, location);
		}
		...
		/// <param name="name">The cache name for the template.</param>
		/// <param name="location">[Optional] The location of the template. This is used to report errors for the correct file or to be able to debug a template. Set it to null if you don't want provide this information. </param>
		public static void Compile(string template, Type modelType, string name, string location = null)
		{
			DefaultTemplateService.Compile(template, modelType, name, location);
		}
		...
		/// <param name="name">The cache name for the template.</param>
		/// <param name="location">[Optional] The location of the template. This is used to report errors for the correct file or to be able to debug a template. Set it to null if you don't want provide this information. </param>
		public static void CompileWithAnonymous(string template, string name, string location = null)
		{
			DefaultTemplateService.CompileWithAnonymous(template, name, location);
		}
		...
		/// </returns>
		public static string Parse(string template, string name = null, string location = null)
		{
			return DefaultTemplateService.Parse(template, name, location);
		}
		...
		public static string Parse<T>(string template, T model, string name = null, string location = null)
		{
			return DefaultTemplateService.Parse<T>(template, model, name, location);
		}
