...
{
	/// <summary>
	/// Summary description for ResponseBTATest
	/// </summary>
	[TestClass]
	public class ResponseBTATest
	{
		#region Properties
		private static readonly ClientResponseBTA Command1 = new ClientResponseBTA();
		private const string _COMMAND1_RESULT = "$BTA,00100231,{UTCTime},4542.8106N,01344.2720W,2.25,338.0,3,0.0,0.02,0.01,{UTCDate},04,01,100,100,100,R*{CheckSum}";
		...
		private static string GetSentenceWithTimeStamp(ClientResponseBTA command)
		{
			/** Result. */
		...
		[TestMethod]
		public void ResponseBTA_CheckSentenceDeviceID()
		{
			try
			{
				/** Get Sentence. */
		...
		[TestMethod]
		public void ResponseBTA_CheckResult()
		{
