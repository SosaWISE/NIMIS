...
{
	/// <summary>
	/// Summary description for ResponseIZBTest
	/// </summary>
	[TestClass]
	public class ResponseIZBTest
	{
		#region Properties
		private static readonly ClientResponseIZB Command1 = new ClientResponseIZB();
		private const string _COMMAND1_RESULT = "$IZB,00100231,{UTCTime},4542.8106N,01344.2720W,2.25,338.0,3,0.0,0.02,0.01,{UTCDate},04,01,100,100,100,R*{CheckSum}";
		...
		private static string GetSentenceWithTimeStamp(ClientResponseIZB command)
		{
			/** Result. */
