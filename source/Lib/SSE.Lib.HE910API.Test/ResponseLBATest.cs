...
{
	[TestClass]
	public class ResponseLBATest
	{
		#region Properties
		private static readonly ClientResponseLBA Command1 = new ClientResponseLBA();
		private const string _COMMAND1_RESULT = "$LBA,00100231,{UTCTime},4542.8106N,01344.2720W,2.25,338.0,3,0.0,0.02,0.01,{UTCDate},04,01,100,100,100,R*{CheckSum}";
		...
		private static string GetSentenceWithTimeStamp(ClientResponseLBA command)
		{
			/** Result. */
