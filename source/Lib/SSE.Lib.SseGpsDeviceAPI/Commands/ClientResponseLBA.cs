...
{
	public class ClientResponseLBA : ClientResponsePDE
	{
		#region .ctor
		public ClientResponseLBA() : base(string.Empty, CommandDef.LBA) {}
		#endregion .ctor

		#region Contants

		private const string _SENTENCE = "LBA,[DATA_ENVELOP]";
