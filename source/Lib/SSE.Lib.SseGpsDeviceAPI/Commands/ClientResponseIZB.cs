...
{
	public class ClientResponseIZB : ClientResponsePDE
	{
		#region .ctor

		public ClientResponseIZB() : base(string.Empty, CommandDef.IZB)
		{
		}
		...
		private const string _SENTENCE = "IZB,[DATA_ENVELOP]";
