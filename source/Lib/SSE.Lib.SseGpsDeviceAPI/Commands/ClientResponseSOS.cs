...
{
	public class ClientResponseSOS : ClientResponsePDE
	{
		#region .ctor

		public ClientResponseSOS() : base(string.Empty, CommandDef.SOS)
		{
		}
		...
		private const string _SENTENCE = "SOS,[DATA_ENVELOP]";
