...
{
	public class ClientResponseBTA : ClientResponsePDE
	{
		#region .ctor

		public ClientResponseBTA() : base(string.Empty, CommandDef.BTA)
		{
		}
		...
		private const string _SENTENCE = "BTA,[DATA_ENVELOP]";
